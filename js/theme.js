;(function($) {
    "use strict";
    //Avoid unecessarry error, the variable shoule be declare before use.
    ...
    function main_slider(){
        if ( $('#main_slider').length ){
            $("#main_slider").revolution({
                ...
                responsiveLevels:[4096,1320,1199,992,767,375],
                gridwidth:[1170,1170,960,720,700,300],
                gridheight:[900,900,900,900,1200,500],
                lazyType:"smart",
                fallbacks: {
                    simplifyAll:"off",
